            ...
            steps {
                script {
                    ...
                    dir('esp32') {
                        ...
                        bat 'arduino-cli compile --fqbn esp32:esp32:esp32doit-devkit-v1 C:\\ProgramData\\Jenkins\\.jenkins\\workspace\\Testing-IoT-Pipeline\\esp32\\esp32-with-encryption\\esp32-with-encryption.ino'
